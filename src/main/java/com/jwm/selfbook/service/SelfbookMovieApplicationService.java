...
public class SelfbookMovieApplicationService {
    ...
    public SelfbookMovieApplicationService(final MoviesRepository movieRepository, final UsersRepository usersRepository) {
...
//        provideSuggestions(movies, suggestions);
    ...
    private void provideSuggestions(List<Movies> movies, List<Movies> suggestions) {
